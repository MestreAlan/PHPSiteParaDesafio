		...
		<script>
			...
			function closePHP(){
				...
				$.ajax({
					...
					data: { tarefa: tarefa, conhecimentoProgramacao: conhecimentoProgramacao, tarefasFeitas: tarefasFeitas, jaJogouJogosCodedotOrg: jaJogouJogosCodedotOrg, nivelEducacional: nivelEducacional, login: login, perfil: perfil, contadorQuestao: contadorQuestao }
				})
					.done(function( msg ) {
			...
			<div class="container d-flex align-items-center">
			  ...
			  <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li id="identificadorUser" class="nav-item active"><a href="#head-edu" onclick="funcaoLog('Clicou no nome');" class="nav-link">Estado: <?php echo $_SESSION['login']; ?> </a></li>
					<li class="nav-item active"><a href="#head-edu2" onclick="funcaoLog('Clicou em Sair'); closePHP();" class="nav-link">CLIQUE AQUI PARA ESCOLHER OUTRO JOGO</a></li>
				</ul>
			  </div>
			</div>
		  </nav>
